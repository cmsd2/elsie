...
LOCK TABLES `bot_state` WRITE;
/*!40000 ALTER TABLE `bot_state` DISABLE KEYS */;
/*!40000 ALTER TABLE `bot_state` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `plugins` VALUES ('!version','elsie.plugins.Version',NULL);
...
-- Dump completed on 2010-04-28  8:44:41
